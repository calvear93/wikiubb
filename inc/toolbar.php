    ...
    if ($evt->advise_before()){
        ...
        $menu = array_merge($menu, array(
           ...
           array(
                ...
                'icon'   => 'rss.png',
                'open'   => '{{rss>',
                'close'  => ' [feeds (cantidad)] reverse author date details [refresh (tiempo)[d|h|m]]}}',
                'sample' => 'http://www.feedforall.com/sample.xml',
                'block'  => false
                ),
           array(
                'type'   => 'format',
