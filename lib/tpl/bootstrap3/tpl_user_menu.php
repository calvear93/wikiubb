...
<ul class="nav navbar-nav" id="dw__user_menu">
  <li class="dropdown dropdown-large">
    ...
    <a href="#" class="dropdown-toggle faa-horizontal animated-hover" data-toggle="dropdown">
    ...
    <ul class="dropdown-menu dropdown-menu-large" role="menu">
      ...
      <li class="dropdown-header">
        <h4 class="page-header"></i><?php echo hsc($INFO['userinfo']['name']) ?>&nbsp<small><?php echo hsc($_SERVER['REMOTE_USER']) ?></small></h4>
      </li>
        ...
        <ul class="dropdown-menu">
          ...
          <?php
            if ($userhomepageHelper = plugin_load('helper','userhomepage')):
                echo '<li class="dropdown-header">Página Inicio</li>' .
                     '<li>' .
            ...
            <li>
              <a href="<?php echo bootstrap3_user_homepage_link() ?>" title="Home-Page" rel="nofollow">
                <i class="fa fa-fw fa-home"></i> Mi Página Inicio
              </a>
            </li>
            <?php endif; endif; ?>
          <li>
      ...
      <?php echo bootstrap3_action_item('login', 'fa fa-fw fa-power-off text-danger faa-flash animated faa-slow'); ?>
    </ul>
  </li>
</ul>
<?php endif; ?>
