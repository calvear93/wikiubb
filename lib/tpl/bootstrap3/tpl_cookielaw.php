...
?>
<div id="cookieNotice" class="navbar <?php echo ((bootstrap3_conf('inverseNavbar')) ? 'navbar-inverse' : 'navbar-default') ?> navbar-fixed-bottom animated slideInUp">
  <div class="container">
    ...
    <?php
      ...
      echo 'Esta web utiliza cookies para mantener una experiencia adecuada en la navegación.';
    ?>
    </div>
    <div class="navbar-right">
      <button class="btn btn-primary btn-xs navbar-btn" id="cookieDismiss">Aceptar</button>
