...
<?php if (bootstrap3_conf('individualTools')): foreach($tools as $id => $menu): ?>
  ...
  <li class="dropdown">
    ...
    <a href="#" class="dropdown-toggle faa-horizontal animated-hover" data-toggle="dropdown" title="<?php echo $lang[$id.'_tools'] ?>">
...
<?php endforeach; else: ?>
  ...
  <li class="dropdown">
    ...
    <a href="#" class="dropdown-toggle faa-horizontal animated-hover" data-toggle="dropdown" title="<?php $lang['tools'] ?>">
