...
class action_plugin_syntaxhighlighter4 extends DokuWiki_Action_Plugin {
    ...
    public function register(Doku_Event_Handler $controller) {
       ...
       $controller->register_hook('TOOLBAR_DEFINE', 'AFTER', $this, 'sxh_toolbar', array ());
    }
    ...
    function sxh_toolbar(Doku_Event $event, $param) {
        $icobase = '../../plugins/syntaxhighlighter4/';

        $sxh = array (
	        'type' => 'format',
	        'title' => 'Resaltador de Sintaxis',
	        'icon' => $icobase.'sxh.png',
	        'sample' => '...',
	        'open' => '<sxh lenguaje; first-line: 1; gutter: true; highlight: [1[,|-]10]; title: Nuevo Código>\n',
	        'close' => '\n</sxh>',
	    );
        $event->data[] = $sxh;
    }
