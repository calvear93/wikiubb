...
class admin_plugin_acl extends DokuWiki_Admin_Plugin {
    ...
    function _html_acleditor($current){
        ...
        if(is_null($current)){
            echo '<button type="submit" class="btn-success" name="cmd[save]">'.$lang['btn_save'].'</button>'.NL;
        }else{
            echo '<button type="submit" class="btn-success" name="cmd[save]">'.$lang['btn_update'].'</button>'.NL;
            echo '<button type="submit" class="btn-danger" name="cmd[del]">'.$lang['btn_delete'].'</button>'.NL;
        }
    ...
    function _init_acl_config(){
        ...
        $this->specials[] = '@'.$conf['defaultteachergroup'];
    ...
    function _html_table(){
        ...
        echo '<button type="submit" class="btn-success" name="cmd[update]">'.$lang['btn_update'].'</button>';
        echo '</th>';
        echo '</tr>';
        echo '</table>';
        echo '</div>';
