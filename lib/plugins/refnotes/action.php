...
class action_plugin_refnotes extends DokuWiki_Action_Plugin {
    ...
    public function __construct() {
        ...
        $this->afterToolbarDefine = new refnotes_after_toolbar_define();
    }
    ...
    public function register(Doku_Event_Handler $controller) {
        ...
        $this->beforeTplMetaheaderOutput->register($controller);
         $this->afterToolbarDefine->register($controller);
    }
}
...
////////////////////////////////////////////////////////////////////////////////////////////////////
class refnotes_after_toolbar_define {

    /**
     * Register callback
     */
    public function register($controller) {
        $controller->register_hook('TOOLBAR_DEFINE', 'AFTER', $this, 'refnotes_toolbar', array ());
    }

    /**
     *
     */
    public function refnotes_toolbar($event, $param) {
        $icobase = '../../plugins/refnotes/';

        $footnote = array (
	        'type' => 'format',
	        'title' => 'Nota al Pie',
	        'icon' => $icobase.'refnote.png',
	        'sample' => 'Referencia',
	        'open' => '',
	        'close' => '[(Nota al pie de página.)].',
	    );
        $event->data[] = $footnote;
    }
}
