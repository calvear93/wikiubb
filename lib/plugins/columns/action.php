...
class action_plugin_columns extends DokuWiki_Action_Plugin {
    ...
    public function register(Doku_Event_Handler $controller) {
        ...
        $controller->register_hook('TOOLBAR_DEFINE', 'AFTER', $this, 'columns_toolbar', array ());
    }
    ...
    function columns_toolbar(Doku_Event $event, $param) {
        $icobase = '../../plugins/columns/icons/';

        $two = array (
	        'type' => 'format',
	        'title' => 'Dos Columnas',
	        'icon' => $icobase.'two.png',
	        'sample' => 'Texto 1ra columna.',
	        'open' => '<columns>\n',
	        'close' => '\n<column>\nTexto 2da columna.\n</columns>',
	    );
	    $two2 = array (
	        'type' => 'format',
	        'title' => 'Dos Columnas (Anchura)',
	        'icon' => $icobase.'two.png',
	        'sample' => 'Texto 1ra columna con 100% anchura.',
	        'open' => '<columns 100%>\n',
	        'close' => '\n<column 50%>\nTexto 2da columna con 50% anchura.\n</columns>',
	    );
	    $three = array (
	        'type' => 'format',
	        'title' => 'Tres Columnas',
	        'icon' => $icobase.'three.png',
	        'sample' => 'Texto 1ra columna.',
	        'open' => '<columns>\n',
	        'close' => '\n<column>\nTexto 2da columna.\n<column>\nTexto 3ra columna.\n</columns>',
	    );
	    $three2 = array (
	        'type' => 'format',
	        'title' => 'Tres Columnas (Alineación [left;right;center;bottom;middle y combinaciones [left;right;center|bottom;middle]])',
	        'icon' => $icobase.'three.png',
	        'sample' => 'Texto alineado a la izquierda.',
	        'open' => '<columns 50% left>\n',
	        'close' => '\n<column 50% right>\nTexto alineado a la derecha.\n<column 50% center>\nTexto centrado.\n</columns>',
	    );
	    $four = array (
	        'type' => 'format',
	        'title' => 'Cuatro Columnas',
	        'icon' => $icobase.'four.png',
	        'sample' => 'Texto 1ra columna.',
	        'open' => '<columns>\n',
	        'close' => '\n<column>\nTexto 2da columna.\n<column>\nTexto 3ra columna.\n<column>\nTexto 4ta columna.\n</columns>',
	    );
