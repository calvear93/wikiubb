...
$lang['_header_dokuwiki']      = 'Parámetros de WikiUBB';
...
$lang['sneaky_index']          = 'Por defecto, WikiUBB mostrará todos los namespaces en el index. Habilitando esta opción los ocultará si el usuario no tiene permisos de lectura. Los sub-namespaces pueden resultar inaccesibles. El index puede hacerse poco usable dependiendo de las configuraciones ACL.';
...
$lang['defaultteachergroup']   = 'Grupo de docente por defecto';
...
$lang['manager']               = 'Administrador - grupo o usuario con acceso a ciertas tareas de mantenimiento';
$lang['teacherismanager']      = 'Docente es asignado automáticamente al grupo de administrador';
...
$lang['disableactions']        = 'Deshabilitar acciones WikiUBB';
...
$lang['updatecheck']           = '¿Comprobar actualizaciones y advertencias de seguridad? Esta característica requiere que WikiUBB se conecte a update.dokuwiki.org.';
...
$lang['renderer__core']        = '%s (núcleo wikiubb)';
$lang['renderer__plugin']      = '%s (plugin)';
$lang['dnslookups']            = 'WikiUBB buscara los hostnames para usuarios editando las páginas con IP remota. Si usted tiene un servidor DNS bastante lento o que no funcione, favor de desactivar esta opción.';
...
$lang['userewrite_o_2']        = 'Interno de WikiUBB';
